...
void wildPlus4(Hand& other, Hand& a, Card c){
    drawCard(other, a);
    drawCard(other, a);    
    drawCard(other, a);
    drawCard(other, a);
...
void wildComputer(Card& c){
    ...
    modifyColor(c, randomNumber);
    c.displayACard(2, 3);
}
void wildPlus4Computer(Hand& opposite, Hand& available, Card c){
